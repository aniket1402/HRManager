...
<body class="container">
	...
	<div class="custom-border">
		<h5 class="custom-title">
			<span class="custom-title-span">Edit Employee Details</span>
		</h5>
		<div class="m-4">
			<form action="update" method="post">
				<div class="row mt-3 mb-3 justify-content-md-center">
					<label for="emp_code" class="col-sm-2 col-form-label">Employee
						Code:</label>
					<div class="col-sm-10 col-md-6">
						<input type="text" class="form-control" id="emp_code"
							name="emp_code"
							value="<c:out value='${ employee.getEmp_code() }'/>" readonly>
					</div>
				</div>
				<div class="row mb-3 justify-content-md-center">
					...
					<div class="col-sm-10 col-md-6">
						<input type="text" class="form-control" id="emp_name"
							name="emp_name" value="${ employee.getEmp_name() }" required
							maxlength="100">
					</div>
				</div>
				<div class="row mb-3 justify-content-md-center">
					...
					<div class="col-sm-10 col-md-6">
						<input type="text" class="form-control" id="loc" name="loc"
							value="${ employee.getLoc() }" required maxlength="500">
					</div>
				</div>
				<div class="row mb-3 justify-content-md-center">
					...
					<div class="col-sm-10 col-md-6">
						<input type="email" class="form-control" id="email" name="email"
							value="${ employee.getEmail() }" required maxlength="100">
					</div>
				</div>
				<div class="row mb-3 justify-content-md-center">
	...
	<div>
		...
		<form action="delete">
			<input type="hidden" name="emp_code"
				value="${ employee.getEmp_code() }"> <input type="hidden"
				name="userId" value="${ userId }">
			<button class="btn btn-outline-dark btn-block" type="submit">Delete</button>
		</form>
	</div>
